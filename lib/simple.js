...
const sms = async(sock, m) => {
	...
	m.replyImg = (buffer, option = { id: m.chat, caption: '', mentions: sock.parseMention(teks), quoted: m }) => sock.sendMessage(option.id ? option.id : m.chat, {
		image: buffer,
		caption: option.caption,
		mentions: option.mentions
	}, { quoted: option.quoted })
	m.replyVid = (buffer, option = { id: m.chat, caption: '', mentions: sock.parseMention(teks), quoted: m }) => sock.sendMessage(option.id ? option.id : m.chat, {
		video: buffer,
		caption: option.caption,
		mentions: option.mentions
	}, { quoted: option.quoted })
